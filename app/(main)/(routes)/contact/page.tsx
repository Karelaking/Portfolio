...
export const metadata: Metadata = {
	title: "Contact & Collaborations | MK Katiyar",
	description:
		"Get in touch with MK Katiyar for product engineering, full-stack development, API architecture, leadership, or freelance opportunities.",
	alternates: {
		canonical: "/contact",
	},
	openGraph: {
...
const ContactRoutePage = (): React.ReactElement => {
	return (
