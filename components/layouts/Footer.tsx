...
export const Footer = ({ className }: FooterProps): ReactElement => {
  ...
  return (
    <footer className={cn("border-border/60 border-t", className)}>
      <div className="mx-auto w-full max-w-5xl sm:border-x sm:border-dashed py-12">
        <div className="grid gap-8 px-4 text-center sm:grid-cols-2 sm:px-6 md:text-left lg:px-8">
          ...
          <div className="mx-auto flex gap-20 md:flex-row w-full justify-center sm:justify-end">
        ...
        <div className="border-border/60 text-muted-foreground mt-10 flex flex-col items-center justify-between gap-3 border-t px-4 pt-6 text-center text-xs sm:text-normal sm:flex-row sm:px-6 sm:text-left lg:px-8">
