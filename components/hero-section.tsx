  ...
  return (
    <SectionContainer className="relative py-0 my-0">
      ...
      <section
        ...
        id="home"
      >
        <div className="z-10 flex flex-col justify-end mb-8 text-center items-center">
          <h3 className="derk:text-neutral-200 text-7xl first-letter:font-extrabold text-neutral-800 md:leading-18 dark:text-neutral-200 font-mea-culpa tracking-widest first-letter:text-8xl wrap-break-word first-letter:float-left first-letter:leading-45 md:first-letter:leading-12 md:first-letter:tracking-widest first-letter:tracking-tighter text-center md:first-letter:text-9xl md:text-9xl ">
            Mradul kumar
          </h3>
