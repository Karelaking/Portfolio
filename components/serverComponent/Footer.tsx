			...
			<div className="mx-auto w-full max-w-6xl py-12 sm:border-x sm:border-dashed">
				<div className="grid gap-8 px-4 text-center sm:grid-cols-2 sm:px-6 md:text-left lg:px-8">
					<div className="space-y-4">
						<p className="text-muted-foreground text-xs uppercase tracking-[0.25em] sm:tracking-[0.4em]">
							Portfolio
						</p>
				...
				<div className="mt-10 flex flex-col items-center justify-between gap-3 border-border/60 border-t px-4 pt-6 text-center text-muted-foreground text-xs sm:flex-row sm:px-6 sm:text-left sm:text-normal lg:px-8">
					<p>© {year} Portfolio. All rights reserved.</p>
					<p className="uppercase tracking-[0.2em] sm:tracking-[0.3em]">
