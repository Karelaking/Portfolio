...
export const ContactPage = async (): Promise<React.ReactElement> => {
	...
	return (
		<section
			className="relative flex min-h-screen w-full flex-col justify-between overflow-hidden border-b border-neutral-200 bg-white text-neutral-900 shadow-2xl transition-all duration-300 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100"
			data-gsap-stack="true"
			id="contact"
		>
			<GSAPSVGPattern className="left-0 top-0 h-full w-full opacity-15" variant="tech-grid" />
			<GSAPEmptySpaceDecorations section="contact" />
