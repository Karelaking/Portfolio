...
export const CtaPage = (): React.ReactElement => {
	return (
		<section className="relative flex w-full flex-col justify-between overflow-hidden border-b border-neutral-200 bg-white text-neutral-900 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100">
			{/* Grid Container Wrapper with Full-Height Vertical Borders & Generous Inner Padding */}
			<div className="group relative mx-auto flex w-full max-w-7xl flex-col items-center justify-center border-x border-neutral-200 bg-white px-6 py-10 text-center sm:px-10 sm:py-18 md:py-20 dark:border-neutral-800 dark:bg-neutral-950">
