...
const Signin = () => {
  return (
    <section className={`bg-gray-1 py-20 ${colorConstants.primaryBackgroundColor} lg:py-[120px]`}>
              ...
              <form>
                ...
                <div className="mb-10">
                  <input
                    ...
                    value="Sign In"
                    onClick={()=>{}}
                    className={`w-full cursor-pointer rounded-md border border-primary bg-primary px-5 py-3 text-base font-medium ${colorConstants.primatyTextColor} transition hover:bg-opacity-90`}
                  />
                </div>
              </form>
...
const InputBox = ({ type, placeholder, name }:InputBoxType) => {
  return (
    <div className="mb-6">
      <input
        type={type}
