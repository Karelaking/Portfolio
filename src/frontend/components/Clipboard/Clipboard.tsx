        ...
        <div className="mx-auto w-full max-w-[400px]">
          <div className="relative">
            <input
              ...
              className="h-12 w-full rounded-lg border border-stroke bg-gray-1 py-3 pl-5 pr-14 text-dark outline-none duration-200 selection:bg-transparent focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-white"
            />
            <button
              onClick={copyToClipboard}
              className="absolute right-2 top-1/2 inline-flex h-8 -translate-y-1/2 items-center justify-center gap-1 rounded-md bg-dark px-2.5 py-1.5 text-sm font-medium text-white duration-200 hover:bg-dark/90"
            >
              <span>
                {copySuccess ? (
                  <svg
